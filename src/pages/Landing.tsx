...
import heroImg from "/referenciadoreshero.png";
import notebookImg from "/notebook.jpg";
import celImg from "/cel.jpg";
import calculadoraImg from "/calculadora.jpg";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 sm:h-10 sm:w-10 flex items-center justify-center p-0">
            <img src={logo} alt="COBER" className="h-full w-full object-contain" />
          </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pt-6 sm:pt-12 lg:pt-16 pb-8 sm:pb-12 lg:pb-20 text-center">
        <div className="mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 items-center">
            <div className="mx-auto md:mx-0 flex h-36 w-36 sm:h-48 sm:w-48 md:h-64 md:w-64 lg:h-80 lg:w-80 items-center justify-center rounded-full bg-primary/10 order-1 md:order-2 overflow-hidden">
              <img src={heroImg} alt="Referenciados" className="h-full w-full object-cover" />
            </div>
            <div className="text-center md:text-left order-2 md:order-1">
              ...
              <p className="mb-6 text-muted-foreground text-sm sm:text-base lg:text-xl">
                Sumate al programa de Conectados de Cober y generá ingresos recomendando planes de medicina prepaga.
              </p>
        ...
        <div className="max-w-6xl mx-auto pt-12 sm:pt-16 lg:pt-20">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
            {[
              ...
              { icon: TrendingUp, title: "Comisiones atractivas", desc: "Ganá créditos por cada Conectado que se convierta en alta." },
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden h-48 sm:h-64 flex items-center justify-center mb-4 sm:mb-6 bg-transparent p-0">
                <img src={notebookImg} alt="Notebook" className="w-full h-full object-cover border-0 shadow-none" />
              </div>
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden h-48 sm:h-64 flex items-center justify-center mb-4 sm:mb-6 bg-transparent p-0">
                <img src={celImg} alt="Conectá" className="w-full h-full object-cover border-0 shadow-none" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2">Conectá</h3>
              <p className="text-muted-foreground text-sm sm:text-base">
                Empezá a registrar Conectados en la plataforma
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden h-48 sm:h-64 flex items-center justify-center mb-4 sm:mb-6 bg-transparent p-0">
                <img src={calculadoraImg} alt="Calculadora" className="w-full h-full object-cover border-0 shadow-none" />
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-muted-foreground">
                Programa de Conectados - Conectá y Ganá
              </p>
            </div>
